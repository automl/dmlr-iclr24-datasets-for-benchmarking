...
class RegCocktailsDimEmbedModel(BaseRegCocktailsModel):
    def __init__(
        self,
    ...
    def get_search_space_updates(has_categorical_columns: bool = True) -> HyperparameterSearchSpaceUpdates | None:
        ...
        return get_updates_for_regularization_cocktails(
            search_embedding=False, embedding_choice="dim_reduce", has_categorical_columns=has_categorical_columns
        )
