...
class RegCocktailsReducedEmbeddingModel(BaseRegCocktailsModel):
    def __init__(
        self,
    ...
    def get_search_space_updates(has_categorical_columns: bool = True) -> HyperparameterSearchSpaceUpdates | None:
        ...
        return get_updates_for_regularization_cocktails(
            search_embedding=False, embedding_choice="reduced", has_categorical_columns=has_categorical_columns
        )
