...
from tabular_data_experiments.models.model_library.TabSurvey.models.basemodel_torch import (
    BaseModelTorch,
)
from tabular_data_experiments.models.model_library.TabSurvey.models.saint_lib.augmentations import (
    embed_data_mask,
)
from tabular_data_experiments.models.model_library.TabSurvey.models.saint_lib.data_openml import (
    DataSetCatCon,
)
from tabular_data_experiments.models.model_library.TabSurvey.models.saint_lib.models.pretrainmodel import (
    SAINT as SAINTModel,
)
...
class SAINT(BaseModelTorch):
    def __init__(self, params, args):
        ...
        self.min_val_loss_epoch = 0 if self.args.early_stopping_rounds > 0 else self.args.epochs
    ...
    def fit(self, X, y, X_val=None, y_val=None):
        ...
        X_val = {"data": X_val, "mask": np.ones_like(X_val)} if X_val is not None else None
        y_val = {"data": y_val.reshape(-1, 1)} if y_val is not None else None
        ...
        for epoch in range(self.args.epochs):
            ...
            if X_val is not None and y_val is not None:
                ...
                if self.min_val_loss_epoch + self.args.early_stopping_rounds < epoch:
