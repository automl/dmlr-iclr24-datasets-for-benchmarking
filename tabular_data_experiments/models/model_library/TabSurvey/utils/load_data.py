...
def load_data(args):
    ...
    if args.dataset == "CaliforniaHousing":  # Regression dataset
        ...
        args.dataset == "Adult" or args.dataset == "AdultCat"
    ):  # Binary classification dataset with categorical data, if you pass AdultCat, the numerical columns will be discretized.
