...
def get_parser():
    ...
    parser.add(
        ...
        default="config/adult.yml",
    )  # kddcup99 covertype california_housing adult higgs
    ...
    parser.add("--optimize_hyperparameters", action="store_true", help="Search for the best hyperparameters")
    parser.add("--n_trials", type=int, default=100, help="Number of trials for the hyperparameter optimization")
    parser.add(
        "--direction", type=str, default="minimize", choices=["minimize", "maximize"], help="Direction of optimization."
    )
    ...
    parser.add(
        ...
        type=int,
        action="append",
        help="Cardinality of the categorical features (is set " "automatically, when the load_data function is used.",
    )
...
def get_given_parameters_parser():
    ...
    parser.add(
        ...
        "--best_params_file",
        is_config_file_arg=True,
        default="config/best_params.yml",
...
def get_attribution_parser():
    ...
    parser.add(
        ...
        is_config_file_arg=True,
        help="parameter file path",
        default="config/adult_params.yml",
    )  # kddcup99 covertype california_housing adult higgs
